...
const GroceryBtnContainer = ({index, setAlertVisibility}) => {
	...
	const edit = (index) => {
		dispatch(editItem({index: index, value: buds[index].item}));
	};	
	...
	return (
		<div className={classes.btnContainer}>
			<button type="button" className={classes.editBtn} onClick={() => {edit(index)}}>
			...
			<button type="button" className={classes.deleteBtn} onClick={() => {remove(index)}}>
...
export default GroceryBtnContainer;